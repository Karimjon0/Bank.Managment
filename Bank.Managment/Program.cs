...
if (command == 1)
{
    ...
    Users userLogIn = InputRegistrUserInfo();
    ...
    if (isThere is false)
    {
        ...
        Users userSignUp = InputRegistrUserInfo();
...
else if (command == 2)
{
    ...
    Console.Clear();
    Console.WriteLine("============= Sign Up =============\n");
    Users userSinnUp = InputRegistrUserInfo();
    Users userInfo = bankProcessingService.PostUser(userSinnUp);
...
static Users InputRegistrUserInfo()
{
